...
<template>
    <div class="w-1/2 bg-white p-3 shadow-md rounded-xl">
            <!-- table -->
            <div class="flex flex-col w-full mt-4 gap-1">
                <div class="flex bg-blue-100 py-1 px-3 justify-between items-center rounded-md">
                    ...
                    <div class="w-2/5 text-sm font-semibold text-center">Date de inscrire</div>
                ...
                <div class="h-96 overflow-y-auto flex flex-col gap-2">
                    <div v-for="User in Users" :key="User.id" class="flex w-full bg-white px-2 items-center">
                       ...
                       <div class="w-2/5 text-sm text-center">{{ formatDate(User.created_at) }}</div>
