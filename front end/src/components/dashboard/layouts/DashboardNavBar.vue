    ...
    <aside class="z-40 px-1 bg-white w-1/6 max-sm:h-fit max-sm:w-full max-xl:w-fit shadow-lg shadow-slate-300 h-screen fixed max-sm:bottom-0 mt-14 pt-12 max-sm:mt-0 max-sm:pt-0 transition-all duration-1000 ease-in-out" :id="closesideBar==true?'closeNav':''">
        <nav class="h-full max-sm:h-fit max-sm:w-full max-xl:w-fit max-sm:border-t-2 transition-all duration-1000 ease-in-out" :id="closesideBar==true?'closeNav':''">
          <ul class="flex flex-col max-sm:flex-row max-sm:h-fit max-sm:w-full max-sm:justify-evenly max-sm:items-center h-full max-sm:py-3 max-xl:w-fit transition-all duration-1000 ease-in-out" :id="closesideBar==true?'closeNav':''">
            ...
            <li v-if="Permissions_roles.roles =='admin'" @click="titleDashbord('Users')" :class="['flex items-center px-7 gap-3 max-sm:gap-0 font-semibold text-lg hover:bg-gray-200 max-sm:hover:bg-white hover:pl-8 max-sm:hover:pl-0 max-sm:p-0 p-2 transition-all duration-1000 ease-in-out cursor-pointer',Dashbordtitle=='Users'?'bg-gray-200 hover:pl-8 max-sm:hover:pl-0':'']"><i class="fa-solid fa-users text-2xl"></i><span :class="['max-xl:hidden',closesideBar==true?'spanHidden':'']">Users</span></li>           
            ...
            <li @click="titleDashbord('Le peintre')" :class="['flex items-center px-7 gap-3 max-sm:gap-0 font-semibold text-lg hover:bg-gray-200 max-sm:hover:bg-white hover:pl-8 max-sm:hover:pl-0 max-sm:p-0 p-2 transition-all duration-1000 ease-in-out cursor-pointer',Dashbordtitle=='Le peintre'?'bg-gray-200 hover:pl-8 max-sm:hover:pl-0':'']"><i class="fa-solid fa-pen-fancy text-2xl"></i><span :class="['max-xl:hidden',closesideBar==true?'spanHidden':'']">Le peintre</span></li>
            ...
            <li @click="titleDashbord('Temps')" :class="['flex items-center px-7 gap-3 max-sm:gap-0 font-semibold text-lg hover:bg-gray-200 max-sm:hover:bg-white hover:pl-8 max-sm:hover:pl-0 max-sm:p-0 p-2 transition-all duration-1000 ease-in-out cursor-pointer',Dashbordtitle=='Temps'?'bg-gray-200 hover:pl-8 max-sm:hover:pl-0':'']"><i class="fa-solid fa-clock  text-2xl"></i><span :class="['max-xl:hidden',closesideBar==true?'spanHidden':'']">Temps</span></li>
